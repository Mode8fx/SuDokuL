...
#define TEXT_TIME_Y                       (game_sidebar_small_1.y + (game_sidebar_small_1.h / 4))
#define TEXT_EMPTY_Y                      (game_sidebar_small_2.y + (game_sidebar_small_2.h / 4))
#define TEXT_GAME_EASY_Y                  (game_sidebar_small_3.y + (game_sidebar_small_3.h - FONT_SIZE) / 2)
