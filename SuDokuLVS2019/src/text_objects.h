...
#define TEXT_TIME_Y                       (gameSidebarSmall1Rect.y + (gameSidebarSmall1Rect.h / 4))
#define TEXT_EMPTY_Y                      (gameSidebarSmall2Rect.y + (gameSidebarSmall2Rect.h / 4))
#define TEXT_GAME_EASY_Y                  (gameSidebarSmall3Rect.y + (gameSidebarSmall3Rect.h - FONT_SIZE) / 2)
