...
Uint8 defaultResetOnCloseSetting;
...
SpriteObject *currMiniGridCursor;
...
TextObject text_Mini_Grid_Behavior;
...
TextObject text_Keep_On_Close;
TextObject text_Reset_On_Close;
