...
int main(int argv, char** args) {
...
#endif
	SET_TEXT_WITH_OUTLINE_ANIMATED("v1.5",    text_Version_Number, (gameWidth - (text_Version_Number.rect.w * 1.25)), TEXT_VERSION_NUMBER_Y);
	if (compactDisplay) {
	...
	while (isRunning) {
		...
		if (keyPressed(INPUT_PREV_TRACK) && wentPastTitleScreen) {
			...
			saveCurrentSettingsIfNotRecentSongChange();
		}
