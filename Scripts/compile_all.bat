...
set REPO=D:/GitHub/SuDokuL/SuDokuLVS2019
set REPO_DKP=/d/GitHub/SuDokuL/SuDokuLVS2019
...
set OUTPUT_WINDOWS=%OUTPUT_DIR%-x64/SuDokuL.exe

:: Makefile: Windows x86
set MAKEFILE_MSYS_WINDOWS_X86=%MAKEFILES_MSYS%/Makefile_pc_x86
set OUTPUT_WINDOWS_x86=%OUTPUT_DIR%-x86/SuDokuL.exe

:: Makefile: Linux
set MAKEFILE_WSL_LINUX=%MAKEFILES_WSL%/Makefile_linux
set OUTPUT_LINUX=%OUTPUT_DIR%-linux/SuDokuL
...
set OUTPUT_WII=%OUTPUT_DIR%-wii/apps/SuDokuL/boot.dol
...
set OUTPUT_SWITCH=%OUTPUT_DIR%-switch/switch/SuDokuL/SuDokuL.nro

:: Makefile: 3DS
set MAKEFILE_DKP_3DS=%MAKEFILES_DKP%/Makefile_3ds
set OUTPUT_3DS=%OUTPUT_DIR%-3ds/3ds/SuDokuL/SuDokuL.3dsx
set OUTPUT_3DS_CIA=%OUTPUT_DIR%-3ds-cia/cias/SuDokuL.cia

:: Makefile: PSP
set MAKEFILE_WSL_PSP=%MAKEFILES_WSL%/Makefile_psp
set OUTPUT_PSP=%OUTPUT_DIR%-psp/PSP/GAME/SuDokuL/EBOOT.PBP
...
upx --best --lzma --force %REPO%/sudokul_win64.exe
...
mv %REPO%/build_vita/sudokul.vpk %OUTPUT_VITA%
